...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\user\Desktop\Vocational_Training\FinTech\apps\ml\text_detection_app'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\user\Desktop\Vocational_Training\FinTech\apps\ml\text_detection_app\Scripts\deactivate.nu'
